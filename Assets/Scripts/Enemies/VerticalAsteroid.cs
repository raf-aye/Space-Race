...
// Same as Asteroid, but vertical
public class VerticalAsteroid : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (Time.timeScale != 0f)
        {
            ...
            Vector3 newPosition = transform.position + new Vector3(0f, -1 * moveSpeed * Time.deltaTime, 0f);
            transform.position = newPosition;
        }
